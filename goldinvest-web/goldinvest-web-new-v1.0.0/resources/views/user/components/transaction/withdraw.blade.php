    ...
    <div class="dashboard-list-item-wrapper">
        <div class="dashboard-list-item sent">
            <div class="dashboard-list-left">
                <div class="dashboard-list-user-wrapper">
                    ...
                    <div class="dashboard-list-user-content">
                        <h4 class="title">{{ __("Money Out via ") }}<span class="text--warning">{{ $transaction->gateway_currency->gateway->name  }}</span></h4>
            ...
            <div class="dashboard-list-right">
                ...
                <h6 class="exchange-money">{{ get_amount($transaction->receive_amount) }}{{ $transaction->payment_currency }}</h6>
            </div>
        </div>
        <div class="preview-list-wrapper">
            ...
            <div class="preview-list-item">
                ...
                <div class="preview-list-right">
                    <span class="text--warning">{{ get_amount($transaction->total_payable) }}{{ $transaction->request_currency }}</span>
                </div>
            </div>
            <div class="preview-list-item">
                <div class="preview-list-left">
