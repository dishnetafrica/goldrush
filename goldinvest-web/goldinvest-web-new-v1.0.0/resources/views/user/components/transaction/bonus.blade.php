    ...
    <div class="dashboard-list-item-wrapper">
        <div class="dashboard-list-item sent">
            ...
            <div class="dashboard-list-right">
                ...
                <h6 class="exchange-money">{{ get_amount($transaction->receive_amount) }}{{ @$item->request_currency }}</h6>
            </div>
        </div>
        <div class="preview-list-wrapper">
            <div class="preview-list-item">
                ...
                <div class="preview-list-right">
                    <span>{{ get_amount(1,$transaction->request_currency) . " = " . get_amount($transaction->exchange_rate,$transaction->request_currency) }}</span>
                </div>
            </div>
            <div class="preview-list-item">
                <div class="preview-list-left">
