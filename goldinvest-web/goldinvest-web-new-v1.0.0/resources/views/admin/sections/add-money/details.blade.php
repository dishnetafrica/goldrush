                ...
                <div class="row align-items-center mb-10-none">
                    <div class="col-xl-4 col-lg-4 form-group">
                        <ul class="user-profile-list-two">
                            ...
                            <li class="five">{{ __("Amount:") }} <span>{{ $transaction->request_amount && $transaction->creator_wallet->currency ? get_amount($transaction->request_amount, $transaction->creator_wallet->currency->code) : 'N/A' }}</span></li>
                        </ul>
                    </div>
                    <div class="col-xl-4 col-lg-4 form-group">
                    ...
                    <div class="col-xl-4 col-lg-4 form-group">
                        <ul class="user-profile-list two">
                            ...
                            <li class="three">{{ __("Rate:") }} <span>{{ $transaction->exchange_rate && $transaction->request_currency && $transaction->payment_currency ? '1 ' . $transaction->request_currency . ' = ' . get_amount($transaction->exchange_rate,$transaction->payment_currency,'double') : 'N/A' }}</span></li>
                            <li class="four">{{ __("Payable:") }} <span>{{ $transaction->total_payable && $transaction->payment_currency ? get_amount($transaction->total_payable,$transaction->payment_currency,'double') : 'N/A' }}</span></li>
