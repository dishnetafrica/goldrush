...
@section('content')
                    ...
                    <div class="col-xl-12 col-lg-12">
                        ...
                        <div class="col-xl-12 col-lg-12 form-group">
                            @include('admin.components.form.input',[
                                ...
                                'label_after'   => "*",
                                'name'          => "section_icon",
                                'value'         => old("section_icon",$data->value->section_icon ?? ""),
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#whyChooseUs-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Why Choose Us Item") }}</a>
                </div>
            </div>
                    ...
                    <tbody>
                        @forelse ($data->value->items ?? [] as $key => $item)
                            <tr data-item="{{ json_encode($item) }}">
                                ...
                                <td><span class="text--dark">{{ Str::words($item->language->$system_default_lang->item_description ?? "", 8, '...') }}</span></td>
                                <td>
    ...
    <div id="whyChooseUs-edit" class="mfp-hide large">
                    ...
                    <div class="row mb-10-none mt-3">
                        ...
                        <div class="col-xl-12 col-lg-12 form-group">
                            @include('admin.components.form.input',[
                                ...
                                'type'      => "number",
                                'name'      => "item_no_edit",
                                'value'     => old("item_no_edit",$data->value->item_no ?? "")
                            ])
                        </div>
...
@push('script')
    ...
    <script>
        openModalWhenError("whyChooseUs-add","#whyChooseUs-add");
        openModalWhenError("whyChooseUs-edit","#whyChooseUs-edit");
        ...
        $(".edit-modal-button").click(function(){
            ...
            var editModal = $("#whyChooseUs-edit");

            editModal.find("form").first().find("input[name=target]").val(oldData.id);

            $.each(languages,function(index,item) {
                editModal.find("input[name="+item.code+"_title_edit]").val(oldData.language[item.code]?.title);
                editModal.find("textarea[name="+item.code+"_item_description_edit]").val(oldData.language[item.code]?.item_description);
                editModal.find("input[name=icon_edit]").val(oldData.icon);
                editModal.find("input[name=item_no_edit]").val(oldData.item_no);
            });
           
            openModalBySelector("#whyChooseUs-edit");
