                ...
                <div class="row align-items-center mb-10-none">
                    <div class="col-xl-4 col-lg-4 form-group">
                        <ul class="user-profile-list-three">
                            <li class="bg--base one">{{ __("Full Name") }}: <span>{{ $user->fullname ?? __('N/A') }}</span></li>
                            <li class="bg--info two">{{ __("Username") }}: <span>{{ $user->username ? "@".$user->username : __('N/A') }}</span></li>
                            <li class="bg--success three">{{ __("Email") }}: <span>{{ $user->email ?? __('N/A') }}</span></li>
                            <li class="bg--warning four">{{ __("Status") }}: <span>{{ $user->stringStatus ? __($user->stringStatus->value) : __('N/A') }}</span></li>
                            <li class="bg--danger five">{{ __("Last Login") }}: <span>{{ $user->lastLogin ?? __('N/A') }}</span></li>
                        </ul>
                    </div>
                    <div class="col-xl-4 col-lg-4 form-group">
