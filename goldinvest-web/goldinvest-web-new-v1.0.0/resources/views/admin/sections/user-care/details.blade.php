            ...
            <div class="row">
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{ get_amount($balance) }} {{ get_default_currency_code() }}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{ get_amount($total_transactions) }} {{ get_default_currency_code() }}</h2>
                                </div>
                                <div class="user-badge">
                                    <span class="badge badge--danger">{{ __("Pending") }} {{ get_amount($pending_transactions) }} {{ get_default_currency_code() }}</span>
                                </div>
                            </div>
                            <div class="right">
                                <div class="chart" id="chart6" data-percent="{{ ($total_transactions != 0) ? intval(($pending_transactions/$total_transactions)*100) : '0' }}"><span>@if($total_transactions != 0)
                                    {{ intval(($pending_transactions/$total_transactions)*100) }}%
                                @else
                                    0%
                                @endif</span></div>
                            </div>
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-badge">
                                    <span class="badge badge--danger">{{ __("Canceled") }} {{ get_amount($cancel_add_money) }} {{ get_default_currency_code() }}</span>
                                    <span class="badge badge--warning">{{ __("Pending") }} {{ get_amount($pending_add_money) }} {{ get_default_currency_code() }}</span>
                                </div>
                            </div>
                            <div class="right">
                                <div class="chart" id="chart7" data-percent="{{ ($add_money_amount != 0) ? intval(($pending_add_money/$add_money_amount)*100) : '0' }}"><span>@if($add_money_amount != 0)
                                    {{ intval(($pending_add_money/$add_money_amount)*100) }}%
                                @else
                                    0%
                                @endif</span></div>
                            </div>
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-badge">
                                    <span class="badge badge--danger">{{ __("Canceled") }} {{ get_amount($cancel_money_out) }} {{ get_default_currency_code() }}</span>
                                    <span class="badge badge--warning">{{ __("Pending") }} {{ get_amount($pending_money_out) }} {{ get_default_currency_code() }}</span>
                                </div>
                            </div>
                            <div class="right">
                                <div class="chart" id="chart8" data-percent="{{ ($money_out_amount != 0) ? intval(($pending_money_out/$money_out_amount)*100) : '0' }}"><span>@if($money_out_amount != 0)
                                    {{ intval(($pending_money_out/$money_out_amount)*100) }}%
                                @else
                                    0%
                                @endif</span></div>
                            </div>
                ...
                <div class="col-xxxl-4 col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-15">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                <h6 class="title">{{ __("Total Transfer Money") }}</h6>
                                <div class="user-info">
                                    <h2 class="user-count">{{ get_amount($transfer_money_amount) }} {{ get_default_currency_code() }}</h2>
                                </div>
                                <div class="user-badge">
                                    <span class="badge badge--danger">{{ __("Canceled") }} {{ get_amount($cancel_transfer_money) }} {{ get_default_currency_code() }}</span>
                                    <span class="badge badge--warning">{{ __("Pending") }} {{ get_amount($pending_transfer_money) }} {{ get_default_currency_code() }}</span>
                                </div>
                            </div>
                            <div class="right">
                                <div class="chart" id="chart9" data-percent="{{ ($transfer_money_amount != 0) ? intval(($pending_transfer_money/$transfer_money_amount)*100) : '0' }}"><span>@if($transfer_money_amount != 0)
                                    {{ intval(($pending_transfer_money/$transfer_money_amount)*100) }}%
                                @else
                                    0%
                                @endif</span></div>
                            </div>
                ...
                <div class="col-xxxl-4 col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-15">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            ...
                            <div class="right">
                                <div class="chart" id="chart10" data-percent="{{ ($tickets != 0) ? intval(($active_tickets/$tickets)*100) : '0' }}"><span> @if($tickets != 0)
                                    {{ intval(($active_tickets/$tickets)*100) }}%
                                @else
                                    0%
                                @endif</span></div>
                            </div>
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{get_amount($user->investPlans->sum('invest_amount')) }} {{ get_default_currency_code() }}</h2>
                                </div>
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{get_amount($user->profit->sum('profit_amount')) }} {{ get_default_currency_code() }}</h2>
                                </div>
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{get_amount($user->orders->sum('total_amount')) }} {{ get_default_currency_code() }}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{ $refer_level->title }}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                ...
                                <div class="user-info">
                                    <h2 class="user-count">{{ $refer_users }}</h2>
                                </div>
                            </div>
                            <div class="right">
