<table class="custom-table transaction-search-table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $item->request_amount && $item->creator_wallet->currency ? get_amount($item->request_amount, $item->creator_wallet->currency->code) : 'N/A' }}</td>
            <td><span class="text--info">{{ $item->gateway_currency->gateway->name ?? 'N/A' }}</span></td>
            <td>
