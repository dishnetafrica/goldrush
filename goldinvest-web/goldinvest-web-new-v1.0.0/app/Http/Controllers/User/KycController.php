...
class KycController extends Controller
{
    ...
    public function index()
    {
        ...
        $breadcrumb    =   __("KYC Verification");
        $user = auth()->user();
        $basic_settings = BasicSettings::first();
        if(!$basic_settings->kyc_verification)  return back()->with(['error' => [__('KYC Verification is currently off')]]);
        ...
        return view('user.sections.kyc.index',compact('page_title','user','kyc_fields','kyc_data','breadcrumb'));
    }
