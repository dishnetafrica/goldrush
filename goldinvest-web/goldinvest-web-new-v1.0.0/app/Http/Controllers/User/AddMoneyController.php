...
class AddMoneyController extends Controller
{
    ...
    public function index() {
        ...
        $transactions = Transaction::auth()->addMoney()->with('gateway_currency')->latest('id')->take(3)->get();

        return view('user.sections.add-money.index',compact('page_title','payment_gateways','breadcrumb','transactions'));
    }
    ...
    public function manualSubmit(Request $request,$token) {
        ...
        try{
            $id = DB::table("transactions")->insertGetId([
                'type'                          => PaymentGatewayConst::TYPEADDMONEY,
                'trx_id'                        => generate_unique_string('transactions','trx_id',16, "AM"),
