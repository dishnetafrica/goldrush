...
class ProfileController extends Controller
{
    public function profileInfo() {
        ...
        $response_data['level'] = $user->referLevel->title;
    ...
    public function getStates(){
        ...
        return Response::success([__('States fetch successfully!')],[
            'states'     => get_country_states(request()->id),
        ],200);
    }
    ...
    public function getCities(){
        ...
        return Response::success([__('Cities fetch successfully!')],[
            'cities'     => get_state_cities(request()->id),
        ],200);
    }
