...
class AnnouncementController extends Controller
{
    ...
    public function announcementStore(Request $request) {
        ...
        if(Announcement::where('slug',$slug)->exists()) return back()->with(['error' => [__('Announcement title is similar. Please update/change this title')]]);
        ...
        return redirect()->route('admin.setup.sections.announcement.index')->with(['success' =>  [__('Announcement created successfully!')]]);
    }
    ...
    public function announcementEdit($id) {
        ...
        if(!$announcement) return back()->with(['error' => [__("Announcement doesn't exists!")]]);
    ...
    public function announcementUpdate(Request $request,$id) {
        ...
        return redirect()->route('admin.setup.sections.announcement.index')->with(['success' => [__('Announcement updated successfully!')]]);
    }
