...
class ReceivedMoneyMail extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                ->greeting("Hello ".$form_data['rfullname']." !")
                ->subject("Received Money From ".$form_data['sender_amount']. ' ' .$form_data['sender_currency']." to ".$form_data['receiver_amount'].' '. $form_data['receiver_currency']." Successfully")
                ->line("You have received money successfully")
