        ...
        children: [
          TextSpan(
            text: DynamicLanguage.isLoading
                ? ""
                : DynamicLanguage.key(
                    firstText!), // Fallback to empty string if null
            style: TextStyle(
              color: firstTextColor ?? Colors.black, // Default color if null
          ...
          if (secondText != null)
            TextSpan(
              text: DynamicLanguage.isLoading
                  ? ""
                  : DynamicLanguage.key(secondText!), // Display second text
              style: TextStyle(
                color: secondTextColor ??
                    CustomColor.primaryLightColor, // Default color if null
                fontSize: Dimensions.headingTextSize4,
