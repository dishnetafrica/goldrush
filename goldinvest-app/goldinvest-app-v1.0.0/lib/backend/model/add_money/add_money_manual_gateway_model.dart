...
DynamicInputAddMoneyModel dynamicInputAddMoneyModelFromJson(String str) =>
    DynamicInputAddMoneyModel.fromJson(json.decode(str));

String dynamicInputAddMoneyModelToJson(DynamicInputAddMoneyModel data) =>
    json.encode(data.toJson());

class DynamicInputAddMoneyModel {
  Message message;
  Data data;
  String type;

  DynamicInputAddMoneyModel({
    required this.message,
    required this.data,
    required this.type,
  });

  factory DynamicInputAddMoneyModel.fromJson(Map<String, dynamic> json) =>
      DynamicInputAddMoneyModel(
