part of 'add_money_congratulation_screen.dart';

// ignore: must_be_immutable
class AddMoneyCongratulationMobileScreen extends StatelessWidget {
  AddMoneyCongratulationMobileScreen({super.key});
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          TitleHeading3Widget(
            text:
                "${controller.requestAmount.value.toStringAsFixed(0)} ${LocalStorage.baseCurrencyCode}",
          ...
          _itemBuilderWidget(context, Strings.totalPayable,
              "${controller.totalPayable().toStringAsFixed(4)} ${LocalStorage.baseCurrencyCode}"),
          Divider(
            height: Dimensions.heightSize * 2.5,
            color: CustomColor.blackColor.withValues(alpha: 0.1),
            thickness: 1,
          ...
          _itemBuilderWidget(context, Strings.willGet,
              "${controller.requestAmount.toStringAsFixed(0)} ${LocalStorage.baseCurrencyCode}"),
          Divider(
            height: Dimensions.heightSize * 2.5,
            color: CustomColor.blackColor.withValues(alpha: 0.1),
            thickness: 1,
          ...
          TextButton(
            onPressed: () {
              Get.toNamed(Routes.transactionLogs);
            },
