...
import '../../widgets/item_builder/item_builder.dart';
part 'money_out_congratulation_mobile_screen.dart';

class MoneyOutCongratulationScreen extends StatelessWidget {
  const MoneyOutCongratulationScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return ResponsiveLayout(
        mobileScaffold: MoneyOutCongratulationMobileScreen());
  }
}
