part of 'two_fa_securtiy_verification_screen.dart';

class TwoFaSecurityVerificationScreen extends StatelessWidget {
  final controller = Get.put(TwoFaSecurityVerificationController());

  TwoFaSecurityVerificationScreen({super.key});
  @override
    ...
    return Column(
      ...
      children: [
        const TitleSubTitleWidget(
          ...
          subTitle: Strings.enterTwoFaVerification,
        ),
          ...
          Obx(
            () => controller.isLoading
                ...
                : PrimaryButton(
                    ...
                    onPressed: () {
                      controller.twoFaOtpVerifyProcess();
                    },
